			...
			<div className="hero md:flex mx-auto lg:mx-32 lg:-mt-32">
				<div className="text-white text-center md:text-left -mt-80 md:mt-0">
					...
					<p className="md:w-8/12 mx-6 md:mx-0 mt-4">
						Your Dental solution is now on your hand. You can easily use
						us to live long with your fresh teeth. Finding us is so easy
						for everyone.
					</p>
				...
				<div className="relative">
					<div className="absolute top-16 -left-20 lg:-left-48 rotate-3">
						<img
					...
					<div className="relative top-8 left-20 lg:left-8 rotate-3">
						<img
							className="w-32 md:w-36 lg:w-40"
